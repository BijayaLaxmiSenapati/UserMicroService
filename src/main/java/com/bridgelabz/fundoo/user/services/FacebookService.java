...
public class FacebookService {
	    ...
	    public String createFacebookAuthorizationURL() {
	        ...
	        params.setRedirectUri("http://localhost:8080/swagger-ui.html#!/user45controller/createFacebookAccessTokenUsingGET");
	    ...
	    public void createFacebookAccessToken(String code) {
	        ...
	        AccessGrant accessGrant = connectionFactory.getOAuthOperations().exchangeForAccess(code,
	                "http://localhost:8080/swagger-ui.html#!/user45controller/createFacebookAccessTokenUsingGET", null);
